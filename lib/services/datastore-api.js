...
var Service = function(params) {
  ...
  self.buildRestRouter = function(express) {
    ...
    router.route('/:collectionName').get(function(req, res, next) {
      self.logger.debug('Req[%s] - GET [/%s]', req.traceRequestId, req.params.collectionName);
      res.json({});
    });

    router.route('/:collectionName/:id').get(function(req, res, next) {
    ...
    router.route('/:collectionName/:id').put(function(req, res, next) {
